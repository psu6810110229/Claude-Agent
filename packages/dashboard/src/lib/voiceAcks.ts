 ...
 * sends. It makes Jarvis feel responsive while a slow reply is in flight without
 ...
 * each so Jarvis does not always say the same line. No "นะ"/"นะครับ", no
 * follow-up question (Jarvis prompt rules).
 */
const FIRST_POOLS: Record<AckContext, string[]> = {
  line: [
    "กำลังเช็กจาก export ล่าสุดครับ",
    "ขอเปิดดู export ไลน์ให้ก่อนครับ",
    "กำลังไล่ข้อความที่ export ไว้ครับ",
    "ขอตรวจ export ล่าสุดสักครู่ครับ",
  ],
  calendar: [
    "กำลังดูตารางให้ครับ",
    "ขอเช็กปฏิทินให้ก่อนครับ",
    "กำลังไล่ดูนัดให้ครับ",
    "ขอดูกำหนดการให้สักครู่ครับ",
  ],
  contacts: [
    "กำลังดูรายชื่อให้ครับ",
    "ขอค้นรายชื่อให้ก่อนครับ",
    "กำลังเปิดสมุดติดต่อให้ครับ",
  ],
  gmail: [
    "กำลังเช็กอีเมลให้ครับ",
    "ขอเปิดดูเมลให้ก่อนครับ",
    "กำลังไล่ดูกล่องจดหมายให้ครับ",
  ],
  tasks: [
    "กำลังดูงานที่ค้างให้ครับ",
    "ขอเช็กรายการงานให้ก่อนครับ",
    "กำลังไล่ดู task ให้ครับ",
  ],
  reminders: [
    "กำลังดูรายการเตือนให้ครับ",
    "ขอเช็กตัวเตือนให้ก่อนครับ",
    "กำลังไล่ดูที่ตั้งเตือนไว้ครับ",
  ],
  drive: [
    "กำลังค้นไฟล์ใน Drive ให้ครับ",
    "ขอเปิดดูไฟล์ให้ก่อนครับ",
    "กำลังไล่ดูไฟล์ให้ครับ",
  ],
  memory: [
    "กำลังเปิดดูข้อมูลที่จำไว้ให้ครับ",
    "ขอไล่ดูบันทึกความจำให้ก่อนครับ",
    "กำลังค้นสิ่งที่จำไว้ให้ครับ",
  ],
  brief: [
    "กำลังรวบรวมสรุปให้ครับ",
    "ขอเรียบเรียงข้อมูลให้สักครู่ครับ",
    "กำลังประมวลภาพรวมให้ครับ",
  ],
  generic: [
    "กำลังดูให้ครับ",
    "สักครู่ครับ",
    "ขอเช็กให้ก่อนครับ",
    "กำลังรวบรวมข้อมูลให้ครับ",
    "ขอเวลาตรวจสอบสักครู่ครับ",
  ],
};
...
const LONG_PHRASES = [
  "ยังตรวจอยู่ครับ",
  "ขอไล่ข้อมูลอีกนิดครับ",
  "ขอเวลาอีกสักครู่ครับ",
  "ยังรวบรวมข้อมูลอยู่ครับ",
  "ขอตรวจให้ครบก่อนครับ",
  "ใกล้เสร็จแล้วครับ",
];
